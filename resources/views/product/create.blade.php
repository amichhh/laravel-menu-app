  ...
  <div class="container mt-3" style="max-width: 720px;">
    ...
    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group" style="margin-top: 30px; margin-bottom: 30px">
        <label for="name" class="fw-bold">商品名</label>
      ...
      <div class="form-group" style="margin-bottom: 30px">
        <label for="textarea" class="fw-bold">詳細</label>
      ...
      <div class="form-group" style="margin-bottom: 30px">
        <label for="category" class="fw-bold">カテゴリー</label>
        ...
        <div class="text-end mt-2">
          <a type="button" href="{{ url('/category/create/') }}" class="btn btn-outline-secondary py-1"
            role="button">新規追加</a>
          <a type="button" href="{{ url('/category/') }}" class="btn btn-outline-secondary py-1" role="button">編集</a>
        </div>
      </div>
      <div class="form-group" style="margin-bottom: 30px">
        <label for="image" class="fw-bold mb-1">画像アップロード</label><br>
