...
@section('content')
  <div class="container-fluid my-2">
    <div class="row m-2">
      <div class="col">
        <h3 class="fw-bold">ダッシュボード</h3>
      </div>
      <div class="col text-end">
        <a type="button" href="{{ url('/product/create/') }}" class="btn btn-primary text-end" role="button"><i
            class="fas fa-plus"></i> 新規追加</a>
      </div>
    </div>
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                  data-bs-target="#exampleModal{{ $product->id }}"><i class="far fa-trash-alt"></i> 削除</button>
